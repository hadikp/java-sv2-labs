...
class TrainingCompanyTest {
    ...
    void testGetCheaperCourse() {
        Course expected = company.getCheaperCourse(40000);
    ...
    void testGetNameOfCourseWithGivenLevel() {
        assertEquals("Fodrász", company.getNameOfCourseWithGivenLevel(Level.BEGINNER));
    }

    @Test
    void testGetNameOfCourseWithGivenLevelNoCourseFound() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> company.getNameOfCourseWithGivenLevel(Level.EXPERT));
        assertEquals("Sorry, there is no course at this level.", ex.getMessage());
    }
